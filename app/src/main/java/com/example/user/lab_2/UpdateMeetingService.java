...
public class UpdateMeetingService extends IntentService {
    public UpdateMeetingService() {
        super("UpdateMeetingService");
    }
    ...
    public static final String ACTION_MYINTENTSERVICE = "com.example.user.lab_2up.RESPONSE";
