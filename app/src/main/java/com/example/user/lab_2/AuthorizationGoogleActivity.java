...
public class AuthorizationGoogleActivity extends AppCompatActivity implements
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(AuthorizationGoogleActivity.this, "Authentication failed.",
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            startActivity(new Intent(AuthorizationGoogleActivity.this, MainActivity.class));
                            finish();
                        }
                    }
                });
